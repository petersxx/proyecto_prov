export const MESAS = [
  // ── Barra ─────────────────────────────────────────────────────────────────
  { id: '16',  nombre: 'Mesa 16',  zona: 'barra',   min: 2, max: 2,  forma: 'circle' },

  // ── Salón ──────────────────────────────────────────────────────────────────
  { id: '2',   nombre: 'Mesa 2',   zona: 'salon',   min: 6, max: 7,  forma: 'rect'   },
  ...
  { id: '7',   nombre: 'Mesa 7',   zona: 'salon',   min: 3, max: 4,  forma: 'rect'   },
  { id: '8',   nombre: 'Mesa 8',   zona: 'salon',   min: 4, max: 5,  forma: 'circle' },
  { id: '9',   nombre: 'Mesa 9',   zona: 'salon',   min: 3, max: 4,  forma: 'rect'   },
  { id: '10',  nombre: 'Mesa 10',  zona: 'salon',   min: 2, max: 3,  forma: 'rect'   },
  { id: '11',  nombre: 'Mesa 11',  zona: 'salon',   min: 2, max: 3,  forma: 'rect'   },
  ...
  { id: '23A', nombre: 'Mesa 23A', zona: 'terraza', min: 2, max: 3,  forma: 'rect'   },
  { id: '23B', nombre: 'Mesa 23B', zona: 'terraza', min: 2, max: 3,  forma: 'rect'   },
  { id: '24A', nombre: 'Mesa 24A', zona: 'terraza', min: 2, max: 3,  forma: 'rect'   },
  ...
  { id: '40',  nombre: 'Mesa 40',  zona: 'vereda',  min: 2, max: 4,  forma: 'circle', reservable: false },
  { id: '41',  nombre: 'Mesa 41',  zona: 'vereda',  min: 2, max: 4,  forma: 'circle', reservable: false },
  { id: '42',  nombre: 'Mesa 42',  zona: 'vereda',  min: 2, max: 2,  forma: 'circle', reservable: false },
  { id: '50',  nombre: 'Mesa 50',  zona: 'vereda',  min: 2, max: 4,  forma: 'circle', reservable: false },
  { id: '51',  nombre: 'Mesa 51',  zona: 'vereda',  min: 2, max: 4,  forma: 'circle', reservable: false },
  { id: '52',  nombre: 'Mesa 52',  zona: 'vereda',  min: 2, max: 2,  forma: 'circle', reservable: false },
]
